...
namespace OOP_10
{
    class Program
    {
        ...
        {
            //1 задание
            ConcurrentDictionary<string, Internet_resours> Internetcollection = new ConcurrentDictionary<string, Internet_resours>();
            //Dictionary<string, Internet_resours> Internetcollection = new Dictionary<string, Internet_resours>();
            Internet_resours shop1 = new Internet_resours("AliExpress", "одежда", "аксессуары");
            ...
            Internetcollection.TryAdd(shop1.internetres, shop1);
            ...
            universal_collection.TryAdd(1, "пук");
            ...
            ObservableCollection<Internet_resours> obscol = new ObservableCollection<Internet_resours>();
